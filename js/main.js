...
// Monuments Central Setion

// const pdfLinks = {
//   puri: "assets/central-monuments/List of CPM _Puri.pdf",
//   bbsr: "assets/central-monuments/List of CPM_BBSR.pdf"
// };
// const tableData = {
//   puri: [
//     { sl: 1, name: "Shri Jagannath Temple", period: "12th Century CE", locality: "Puri", district: "Odisha" },
//     { sl: 2, name: "Konark Sun Temple", period: "13th Century CE", locality: "Konark", district: "Odisha" },
//     { sl: 3, name: "Chausathi Yogini Temple", period: "-", locality: "Chaurasi", district: "Odisha" }
//   ],
//   bbsr: [
//     { sl: 1, name: "Lingaraj Temple", period: "11th Century CE", locality: "Bhubaneswar", district: "Odisha" },
//     { sl: 2, name: "Mukteswar Temple", period: "10th Century CE", locality: "Bhubaneswar", district: "Odisha" },
//     { sl: 3, name: "Rajarani Temple", period: "11th Century CE", locality: "Bhubaneswar", district: "Odisha" }
//   ]
// };
...
//     window.open(pdfLinks[circle], "_blank");
//   };

//   // Update Table
//   tbody.innerHTML = "";
//   tableData[circle].forEach(row => {
//     tbody.innerHTML += `
//       <tr>
//         <td>${row.sl}</td>
//         <td>${row.name}</td>
...
//           <a href="view-centralmonuments.html" class="view-details.svg" title="View Monument Details">
...
//         </td>
//         <td class="text-center">
//           <button type="button" data-panorama="assets/virtual-tour/virtual_tour.jpg" onclick="openVirtualTour(this)"
//                 class="icon-btn">
//                 <svg fill="#ff9900" height="35px" width="50px" version="1.1" id="Layer_1"
//                   xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
//                   viewBox="-4.8 -4.8 489.60 489.60" xml:space="preserve">
...
function updateCircle() {
  const selected = document.getElementById("circleSelect").value;
  const rows = document.querySelectorAll("#centralMonumentsTableBody tr");

  rows.forEach(row => {
    row.style.display =
      row.getAttribute("data-circle") === selected ? "" : "none";
  });
  document.getElementById("downloadBtn").onclick = function () {
    window.open(pdfLinks[selected], "_blank");
  };
}
updateCircle();
